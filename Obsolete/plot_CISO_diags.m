function fig = plot_CISO_diags(fig, my_time, plot_layer, surface, interior, time_series)
...
myTitle = sprintf('CISO Interior Diags v. Depth (m) @day %d, iteration = %d', round(my_time/60*60*24), iter); % sec_d
